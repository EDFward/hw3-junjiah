 ...
 * XML source: /home/diwang/ur-workspace/hw3-archetype/src/main/resources/descriptors/typesystems/VectorSpaceTypes.xml
 *
 * @generated
 */
public class Document extends Annotation {
  ...
  public int getRelevanceValue() {
    if (Document_Type.featOkTst && ((Document_Type) jcasType).casFeat_relevanceValue == null) {
      jcasType.jcas.throwFeatMissing("relevanceValue",
              "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Document");
    }
    return jcasType.ll_cas
            .ll_getIntValue(addr, ((Document_Type) jcasType).casFeatCode_relevanceValue);
  }
  ...
  public int getQueryID() {
    if (Document_Type.featOkTst && ((Document_Type) jcasType).casFeat_queryID == null) {
      jcasType.jcas.throwFeatMissing("queryID",
              "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Document");
    }
  ...
  public String getText() {
    if (Document_Type.featOkTst && ((Document_Type) jcasType).casFeat_text == null) {
      jcasType.jcas
              .throwFeatMissing("text", "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Document");
    }
  ...
  public FSList getTokenList() {
    if (Document_Type.featOkTst && ((Document_Type) jcasType).casFeat_tokenList == null) {
      jcasType.jcas.throwFeatMissing("tokenList",
              "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Document");
    }
    return (FSList) (jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas
            .ll_getRefValue(addr, ((Document_Type) jcasType).casFeatCode_tokenList)));
  }
  ...
  public void setTokenList(FSList v) {
    ...
    jcasType.ll_cas.ll_setRefValue(addr, ((Document_Type) jcasType).casFeatCode_tokenList,

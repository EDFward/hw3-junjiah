...
public class StanfordLemmatizer {
  ...
  public static String stemWord(String w) {
    ...
    try {
      ...
      /*
       * TODO should we ignore stack overflow here? so far it happens only for very long tokens, but
       * how knows, there might be some other reasons as well. In that, if stemming failed, we can
       * simply return the origina, unmodified, string.
       */
      e.printStackTrace();

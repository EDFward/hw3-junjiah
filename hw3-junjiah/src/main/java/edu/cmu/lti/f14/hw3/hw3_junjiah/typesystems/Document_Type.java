...
package edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems;
...
public class Document_Type extends Annotation_Type {
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Document");
  ...
  public int getRelevanceValue(int addr) {
    if (featOkTst && casFeat_relevanceValue == null) {
      jcas.throwFeatMissing("relevanceValue",
              "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Document");
    }
  ...
  public int getQueryID(int addr) {
    if (featOkTst && casFeat_queryID == null) {
      jcas.throwFeatMissing("queryID", "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Document");
    }
  ...
  public String getText(int addr) {
    if (featOkTst && casFeat_text == null) {
      jcas.throwFeatMissing("text", "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Document");
    }
  ...
  public int getTokenList(int addr) {
    if (featOkTst && casFeat_tokenList == null) {
      jcas.throwFeatMissing("tokenList", "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Document");
    }
  ...
  public Document_Type(JCas jcas, Type casType) {
    ...
    casFeat_relevanceValue = jcas
            .getRequiredFeatureDE(casType, "relevanceValue", "uima.cas.Integer", featOkTst);
    casFeatCode_relevanceValue = (null == casFeat_relevanceValue) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_relevanceValue).getCode();

    casFeat_queryID = jcas.getRequiredFeatureDE(casType, "queryID", "uima.cas.Integer", featOkTst);
    casFeatCode_queryID = (null == casFeat_queryID) ?
            JCas.INVALID_FEATURE_CODE :
            ((FeatureImpl) casFeat_queryID).getCode();
    ...
    casFeat_tokenList = jcas
            .getRequiredFeatureDE(casType, "tokenList", "uima.cas.FSList", featOkTst);
    casFeatCode_tokenList = (null == casFeat_tokenList) ?
            JCas.INVALID_FEATURE_CODE :

...
public class Token extends Annotation {
  ...
  public String getText() {
    if (Token_Type.featOkTst && ((Token_Type) jcasType).casFeat_text == null) {
      jcasType.jcas.throwFeatMissing("text", "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Token");
    }
  ...
  public int getFrequency() {
    if (Token_Type.featOkTst && ((Token_Type) jcasType).casFeat_frequency == null) {
      jcasType.jcas
              .throwFeatMissing("frequency", "edu.cmu.lti.f14.hw3.hw3_junjiah.typesystems.Token");
    }
